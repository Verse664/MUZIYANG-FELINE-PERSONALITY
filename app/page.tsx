...
const fanPhrases: FanPhrase[] = [
  ...
  { text: "爱你是本能呀小洋\n——From 小江", tier: 0, color: "#e7a0b4" },
  { text: "洋洋好温暖，像是全身都冒着粉色泡泡\n——From 浪味仙地", tier: 0, color: "#ffb7cb" },
  { text: "没有什么人生建议，妹妹\n——From WEEKEND", tier: 0, color: "#c66a84" },
  { text: "爱你是本能～专属洋洋\n——From momo", tier: 0, color: "#9f3b57" },
  ...
  { text: "这个世界是美好的，希望洋咪的世界能永远善良、美好。\n——From KK立刻有", tier: 1, color: "#f3a9b6" },
  { text: "他虽然有的时候大大咧咧\n但是他是个内心非常敏感的小咪咪\n——From 初日泡芙酒", tier: 1, color: "#D27B8B" },
  { text: "一个直播切片，\n好像说怎么像他这样豁达（应该是这个词吧）他说都是装的，\n感觉这样的他真实又有魅力\n——From 京畿道的南风宥点冷", tier: 1, color: "#f8cbd3" },
  { text: "我好喜欢他把看演唱会说成一起约会啊\n——From 京畿道的南风宥点冷", tier: 1, color: "#b64f62" },
  { text: "是外表活泼外向，内里温柔有力量的人，\n是爱带给大家开心的开心果，是坚强的，不被外界裹挟的洋洋\n——From land", tier: 1, color: "#C95573" },
  { text: "如果可以，我希望洋洋的路再顺利一点，希望洋更幸福一些\n——From land", tier: 1, color: "#df7a95" },
  { text: "我喜欢热爱舞台热爱音乐热爱ONER的木子洋。\n我希望李振洋健康快乐每一天！\n——From 我爱上班", tier: 1, color: "#C95573" },
  { text: "喜欢你温温柔柔笑起来的模样，喜欢你严肃认真的模样。\n希望你好好爱惜身体，健健康康平平安安。\n——From 木子、、（有联票版）", tier: 1, color: "#e79aaf" },
  { text: "看见你的笑和亮晶晶的眼睛也是我幸福的一种\n——From xiiiao", tier: 1, color: "#C95573" },
  { text: "祝你祝我祝大家——好好吃饭，天天开心💖\n——From Cocorelax", tier: 1, color: "#e887a1" },
  { text: "逃离不了善良底色的猫咪手掌心\n——From 合晴优美", tier: 1, color: "#c76781" },
  { text: "我喜欢他一直以来都有自己的坚持，不别扭不拧巴，坦坦荡荡的\n——From 要对鼻子好一点", tier: 1, color: "#e887a1" },
  { text: "你是我向往的爱本身\n——From 雪碧泡泡🐑", tier: 1, color: "#ce738b" },
  { text: "你就是你，是最好的木子洋\n——From Hhhhlynn", tier: 1, color: "#ce738b" },
  { text: "全世界！不准再欺负这个善良的咪了！\n——From 华尔街喜之郎", tier: 1, color: "#ff96b2" },
  { text: "希望洋洋能得到自己想要的，这是你的嗨收，也是我的嗨收。\n——From 朏朏", tier: 1, color: "#c38797" },
  { text: "喜欢你的温柔细腻，喜欢听你爽朗的大笑，喜欢看你的美丽舞台\n——From 醺醺然", tier: 1, color: "#ce738b" },
  { text: "我们都会走向更大的舞台\n——From 潦草女巫", tier: 1, color: "#d76583" },
  ...
  { text: "洋洋是那种看起来大大咧咧很爱耍宝的，\n实则心思细腻得能承接住每个人的情绪。\n他很真诚，你可以从他的言行中感受出他的热情和他捧出的真心。\n希望他可以多多保重身体，对自己好一些\n——From xcxcxc_", tier: 2, color: "#eda1af" },
  { text: "还记得我和洋洋的初相识是个超级漂亮的双人舞台女位，\n当时满心想法是怎么这么帅气漂亮，跳舞怎么能这么好看！\n入坑之后越了解越觉得洋洋是个很纯粹的人，\n他待人真诚，心思细腻，性格底色极其善良！\n最大的感悟就是温柔的具像化是木子洋！\n——From 今天要睡觉", tier: 2, color: "#D27B8B" },
  { text: "对洋的喜欢逐渐具象化，喜欢他的幽默，喜欢他搞笑，\n喜欢他自带爱人气息，喜欢他的笑容，喜欢他笑起来弯弯的眉眼，\n喜欢他不服输的劲，喜欢他的小傲娇，\n喜欢他护短，真的喜欢这个阳光明媚的少年，\n就是感觉如果被他爱着感觉会很幸福，做他的粉丝也很幸福💗💗\n——From 忧郁冰激凌", tier: 2, color: "#c66275" },
  { text: "温柔是他最永恒的底色，在我眼里他是\n一个内心柔软、需要空间独处，会向内自洽，有责任感的哥哥\n他就是那一棵樱花树，人人见之向往，人人因在他身边而变得更美好，\n然而他只是他，他就是美好本身。\n不问得失只求对错，是坚定而脚踏实地的理想主义者，是悲观主义中的乐天派，\n是矛盾而强大的李振洋，是我行走在前行路上举着蜡烛将我照亮的同行者。\n我因为他点亮了自己的灯，成为了更好的自己，\n所以木子洋全肯定，李振洋全肯定，不是说说而已。\n你已经成为了我人生中的一部分爱你洋洋\n——From 汐汐（小Q）", tier: 2, color: "#D27B8B" },
  { text: "刚认识的时候觉得台风好好啊，好松弛，越了解越发现性格真的好，\n温柔，有格局，有爱心，有解决问题的能力，很靠谱的感觉，\n但是我最喜欢的是他至今还保留的孩子气的一面，\n要知道在当今这个现实的世界里，别说在娱乐圈，\n就是身边的人都很少还有那么鲜活的本色了，人人都像个人机，\n而洋的这一份活人感难能可贵，\n希望洋洋不被任何事情影响，永远保留那一份鲜活开心下去\n——From 熊猫", tier: 2, color: "#b95365" },
  { text: "有一年决定去外地发展，决定的很仓促，是8月出发的，\n那时候人生地不熟，工作不顺利，辗转一番之后已经是初秋了，\n半夜盖着薄被子被冻醒，突然就委屈了起来，\n当时想着，要是有个人能温暖我该多好，\n就这样，洋洋入了我的梦，梦里他从后面抱着我，\n用胸膛温暖我，那种被全身包裹的安全感太真实了。\n虽然是个梦，但是我一直记得，他总让我安心。\n我喜欢看他耍宝，喜欢听他说话，喜欢听他唱歌，喜欢他温柔的喊我们妹妹。\n——From 申生慢~", tier: 2, color: "#ffc3ce" },
  { text: "其实感觉私下的他很像自家哥哥，沉稳永远会兜底，永远是后盾，\n但是也完全不会觉得沉闷，会找吃的，喜欢钓鱼，\n感觉跟他生活会特别有意思，会永远找新事物好玩的东西逗你\n——From 灵辰幻想_Aurora", tier: 2, color: "#f693a5" },
  { text: "咪是一只长的酷酷拽拽其实温柔细腻的大猫呀，我喜欢你的一切模样，\n虽然我是从刷到成都场爱慕困视频入坑，\n但是实际上我在偶练的时候就认识你了呀，\n我们错过了这许多年，我更加珍惜能见到你的每一面，\n所以趁年轻趁热爱，以后多多见面吧！\n——From 上岸！！（见过ONER版）", tier: 2, color: "#df94a8" },
  { text: "我相信你，也更是因为见不得你被骂，\n所以我去了海口，果然我们咪就是从来不让人失望的大猫，\n我看见了我的入坑solo，唯一遗憾的就是没有选择站坑，\n我以前从不知道拥有心肝的感觉是什么样，但现在我想我知道了，\n我爱你从不后悔，只遗憾我来的太晚了，\n我们之间的距离已经那么远了，但我希望你能健康，\n你能幸福，你能开心，你能成功，\n你能被高高的托起，只要这是你想要的，\n哪怕我们之间的距离越来越远，我甘之如饴\n——From 上岸！！（见过ONER版）", tier: 2, color: "#C95573" },
  { text: "最初认识时一直觉得是团内氛围担当会调动所有人的情绪，\n很热情很有活力的奶牛猫一只，但是深入了解才发现，\n其实洋洋的底色是温柔，私下很安静的哥哥。\n希望以后洋洋更在意自己的身体，尤其是膝盖，要越来越好啊！\n——From 赊北.", tier: 2, color: "#C95573" },
  { text: "哥哥不懂热梗，可是哥哥会夸妹妹不再依赖哥哥是成长了很棒，\n会说格莱美也不及妹妹们的心，会心疼妹妹们追线下吃的苦，\n会黏黏糊糊地说不要绝交会说想妹妹，我和哥哥从来都是真心换真心\n——From 沉虞", tier: 2, color: "#C95573" },
  { text: "喜欢木子洋真的很幸福，喜欢温柔的你，感性的你，\n总是为他人考虑的你，喜欢听你讲话，喜欢你的声音，\n喜欢私下安安静静看书和冥想的你，\n看到你的笑和亮晶晶的眼睛也是我幸福的一种，\n喜欢以后爱你的人越来越多。\n——From xiiiao", tier: 2, color: "#C95573" },
  { text: "在我本人最迷茫最不自我怀疑的时候，\n木子洋像一杯温水一样，足够温暖我又不会显得太过浓烈。\n我希望我们可以一直保持这样的状态，互相陪伴走过一个又一个明天。\n——From 淇泡泡www", tier: 2, color: "#C95573" },
  { text: "还记得刚刷到视频入坑，还以为洋洋是大肌肉块身材hhhhh本人审美是薄肌，\n当时还不感兴趣来着，就是觉得这人特别帅，\n后来入坑不到一周就去了线下，当时正值夏季，还是广东！\n为了抢前排看看暴晒了一整天，直到晚上天黑了才开始表演，\n一出场，我的视线就不知不觉老往洋洋身上移，\n很奇怪，当时真的就想照顾所有人，但是视线老是控制不住往洋身上跑，\n当天造型非常青春男大，线下跟网上完全不是一个样子，\n居然是薄肌身材，大宽肩，脸型特别帅气，\n从来没见过这么帅的人，散场之后，\n我就拉着搭子一直滔滔不绝说木子洋好帅啊，真的特别帅，从此垂直入坑，\n——From feather", tier: 2, color: "#C95573" },
  { text: "后面慢慢了解，原来看似阳光活泼活力满满的男人私下还有内心都跟表现出来的完全不一样，\n这更让我心疼，也更加喜欢，感觉跟洋洋性格很像，非常共鸣，\n喜欢洋的路上，遇到了形形色色不同的人，但有一点相同的就是我们爱着同一个美好的人，\n喜欢持续直到现在，就在前两天是喜欢洋的一周年啦！\n爱还在继续,未来还很长,永远太缥缈了，\n那我们就说现在比上一秒更爱你，木子洋天天开心，天天快乐，\n继续往前走吧，有小懂事，氧气，小鱼干会一直在你身后！\n——From feather", tier: 2, color: "#C95573" },
]
